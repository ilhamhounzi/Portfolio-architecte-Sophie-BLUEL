...
document.addEventListener('DOMContentLoaded', () => {
    ...
    filterButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            if (category === 'all') {
                filteredProjects = worksData;
            } else {
                for (const project of worksData) {
                    if (project.categoryId.toString() === category || project.category.name === button.textContent) {
                        filteredProjects.push(project);
                    }
                }
            }

            // Display the filtered projects in the gallery
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add click event listener for the "edit" buttons (assuming they have class 'openModalButton')
    const editButtons = document.querySelectorAll('.openModalButton');
    editButtons.forEach(button => {
        button.addEventListener('click', () => {
            openModalButton(button);
